...
export function Footer(){
    return(
        <footer className="grid grid-col-1 gap-4 lg:gap-0 lg:grid-cols-3 py-4 px-2 md:px-8 lg:px-16">
            <div>
                <p className="text-2xl text-gray-800 font-bold">Bill Limited</p>
                <p className="text-xs text-gray-600">&copy; {year} Bill Limited</p>
            </div>
